...
class AppLocalizations {
  ...
  static const _values = <String, Map<String, String>>{
    'en': {
      ...
      'disabled': 'Disabled',
      'showExperimentalPhoneticResults': 'Show experimental audio findings',
      'phonemeHighlightVisible': 'Highlight the current detected phone',
      'phoneticCachePolicy': 'Audio analysis cache',
      'phoneticCacheKeepCompleted': 'Keep completed results',
      'phoneticCacheTemporary': 'Temporary only',
      ...
      'noTimelineCandidates': 'No WordTimeline candidates',
      'noPhoneTimelineCandidates': 'No PhoneTimeline candidates',
      'noChunkTimelineCandidates': 'No ChunkTimeline candidates',
      'activeTimelineLegacy': 'Active timeline: legacy word timings',
      'activePhoneTimelineMissing':
          'Active sound pattern timeline: analysis fallback',
      'activeChunkTimelineMissing': 'Active chunk timeline: generated fallback',
    ...
    'zh': {
      ...
      'phoneticBatch': '批量分析',
      'disabled': '禁用',
      'showExperimentalPhoneticResults': '显示实验性音频发现',
      'phonemeHighlightVisible': '高亮当前检测音素',
      'phoneticCachePolicy': '音频分析缓存',
      'phoneticCacheKeepCompleted': '保留已完成结果',
      'phoneticCacheTemporary': '仅临时保留',
      ...
      'noTimelineCandidates': '暂无 WordTimeline 候选',
      'noPhoneTimelineCandidates': '暂无 PhoneTimeline 候选',
      'noChunkTimelineCandidates': '暂无 ChunkTimeline 候选',
      'activeTimelineLegacy': '当前时间轴：旧词级时间',
      'activePhoneTimelineMissing': '当前声音模式时间轴：分析降级',
      'activeChunkTimelineMissing': '当前语块时间轴：生成降级',
