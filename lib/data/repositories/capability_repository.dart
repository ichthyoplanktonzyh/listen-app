...
/// The Core 4.0 capability + package-lifecycle surface the coordinator
/// depends on. One seam for the deep completion flow, so tests can drive
/// every state without a live sidecar.
